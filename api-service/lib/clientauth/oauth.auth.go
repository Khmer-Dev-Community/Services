...
type ClientAuthService struct {
	clientUserRepo *userclient.ClientUserRepository // Use userclient repo
}

// NewClientAuthService creates a new instance of ClientAuthService.
func NewClientAuthService(clientUserRepo *userclient.ClientUserRepository) *ClientAuthService { // Expects userclient repo
...
func (s *ClientAuthService) RegisterClient(payload *userclient.ClientRegisterRequestDTO) (*userclient.ClientUser, error) {
	...
	newUser := userclient.ToClientUserFromRegisterDTO(payload) // Direct call, no alias
...
func (s *ClientAuthService) ClientLogin(credentials *userclient.ClientLoginRequestDTO) (*userclient.ClientUser, error) {
...
func (s *ClientAuthService) ExchangeGitHubCodeForToken(code string) (*oauth2.Token, error) {
	...
	token, err := oauth_config.ClientGithubOauthConfig.Exchange(context.Background(), code) // Access config from oauth_config
	if err != nil {
...
func (s *ClientAuthService) GetGitHubUserData(accessToken string) (*oauth_config.GitHubUser, error) { // Use oauth_config.GitHubUser
	...
	var githubUser oauth_config.GitHubUser // Use oauth_config.GitHubUser
...
func (s *ClientAuthService) HandleGitHubLoginOrRegister(githubUser *oauth_config.GitHubUser) (*userclient.ClientUser, error) { // Use oauth_config.GitHubUser
...
func (s *ClientAuthService) GetClientProfile(userID uint) (*userclient.ClientUserResponseDTO, error) {
...
func (s *ClientAuthService) UpdateClientProfile(userID uint, dto *userclient.ClientUpdateRequestDTO) (*userclient.ClientUserResponseDTO, error) {
	...
	userclient.UpdateClientUserFromDTO(user, dto)
